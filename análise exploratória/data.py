...
df = df[df['Nivel de Ensino'] != 'Não informado']
...
salario_por_cargo.plot(kind='bar', color=cores_degrade_roxo_verde)
plt.title('5 Maiores Salários')
...
sns.countplot(y='Setor', data=df, palette='viridis', hue='Setor', dodge=False)
...
plt.figure(figsize=(10, 6))
sns.barplot(x='Genero', y='Media de Salario', data=media_salario_por_genero,hue='Genero', palette='viridis')
plt.xlabel('Gênero')
plt.ylabel('Média de Salário')
...
cargos_comuns = list(cargos_comuns)[:7]
