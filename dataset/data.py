...
nivel_ensino_counts.plot(kind='bar', color='green')
...
plt.figure(figsize=(10, 6))
nivel_ensino_counts_gestores.plot(kind='bar', color='green')
...
salario_por_cargo.plot(kind='bar', color='green')
...
if 'Quais os principais critérios que você leva em consideração no momento de decidir onde trabalhar?' in df.columns:
    ...
    plt.figure(figsize=(10, 6))
    plt.bar(contagem_critérios.keys(), contagem_critérios.values(), color='green')
